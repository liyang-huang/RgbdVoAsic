...
//       
//       Creation Date:  Wed Jun 28 22:11:08 2023
//       Version: 	r5p0
//
...
`ifdef POWER_PINS
module sram_lb_8b (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB,
    QA, QB, CLKA, CENA, WENA, AA, DA, CLKB, CENB, WENB, AB, DB, EMAA, EMAWA, EMASA,
    EMAB, EMAWB, EMASB, TENA, BENA, TCENA, TWENA, TAA, TDA, TQA, TENB, BENB, TCENB,
    TWENB, TAB, TDB, TQB, RET1N, STOVA, STOVB, COLLDISN);
`else
module sram_lb_8b (CENYA, WENYA, AYA, DYA, CENYB, WENYB, AYB, DYB, QA, QB, CLKA, CENA,
 ...
 wire  CLKB_;
  ...
  assign DYB_ = RET1N_ ? (TENB_ ? DB_ : TDB_) : {8{1'bx}};
   `ifdef ARM_FAULT_MODELING
     sram_lb_8b_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .TQ(TQA_), .BEN(BENA_), .WEN(WENA_int), .Q_in(QA_int));
  `else
...
`endif
`timescale 1ns/1ps
module sram_lb_8b_error_injection (Q_out, Q_in, CLK, A, CEN, WEN, BEN, TQ);
   output [7:0] Q_out;
   input [7:0] Q_in;
   input CLK;
   input [9:0] A;
