./liyang-odometry ../../dataset/fr1_360/rgbd_assoc.txt ./result/pose_fr1_360.txt RgbdICP
./liyang-odometry ../../dataset/fr1_desk/rgbd_assoc.txt ./result/pose_fr1_desk.txt RgbdICP
./liyang-odometry ../../dataset/fr1_desk2/rgbd_assoc.txt ./result/pose_fr1_desk2.txt RgbdICP
./liyang-odometry ../../dataset/fr1_floor/rgbd_assoc.txt ./result/pose_fr1_floor.txt RgbdICP
./liyang-odometry ../../dataset/fr1_room/rgbd_assoc.txt ./result/pose_fr1_room.txt RgbdICP
./liyang-odometry ../../dataset/fr1_rpy/rgbd_assoc.txt ./result/pose_fr1_rpy.txt RgbdICP
./liyang-odometry ../../dataset/fr1_xyz/rgbd_assoc.txt ./result/pose_fr1_xyz.txt RgbdICP
